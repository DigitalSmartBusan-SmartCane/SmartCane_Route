...
class MapGUI:
    def __init__(self, master: tk.Tk):
        ...
        self.start_location = (35.132786, 129.106946)  # 부경대학교 창의관
    ...
    def update_map(self, current_location: Tuple[float, float], route: Optional[List[Tuple[float, float]]] = None, destination: Optional[Dict[str, float]] = None):
        ...
        try:
            ...
            # 현재 위치 중심으로 지도 생성 (줌 레벨 증가)
            self.map = folium.Map(location=current_location, zoom_start=17)  # 줌 레벨을 14에서 17로 증가
